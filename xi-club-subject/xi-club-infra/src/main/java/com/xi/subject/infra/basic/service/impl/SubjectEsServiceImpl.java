package com.xi.subject.infra.basic.service.impl;

import com.xi.subject.common.entity.PageResult;
import com.xi.subject.common.enums.SubjectInfoTypeEnum;
import com.xi.subject.infra.basic.entity.EsSubjectFields;
import com.xi.subject.infra.basic.entity.SubjectInfoEs;
import com.xi.subject.infra.basic.es.EsIndexInfo;
import com.xi.subject.infra.basic.es.EsRestClient;
import com.xi.subject.infra.basic.es.EsSearchRequest;
import com.xi.subject.infra.basic.es.EsSourceData;
...
/**
 * 这段代码是基于 Elasticsearch (ES) 实现的题库（科目 / 题目）信息 ES 操作服务层实现类，
 * 核心作用是封装对 ES 中subject_index索引的数据插入和条件搜索（含高亮、分页、权重排序） 逻辑，为上层业务提供标准化的 ES 数据操作接口。
 */
@Service
@Slf4j
public class SubjectEsServiceImpl implements SubjectEsService {
    ...
    //将 SubjectInfoEs 字段映射到 ES 索引的字段（对应 EsSubjectFields 常量）；
    ...
    //（1）构建搜索条件（createSearchListQuery）
